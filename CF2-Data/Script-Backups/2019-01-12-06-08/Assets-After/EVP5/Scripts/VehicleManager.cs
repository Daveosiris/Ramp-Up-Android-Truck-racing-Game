...
public class VehicleManager : MonoBehaviour
	...
	void Update ()
		{
		if (ControlFreak2.CF2Input.GetKeyDown(previousVehicleKey)) SelectPreviousVehicle();
		if (ControlFreak2.CF2Input.GetKeyDown(nextVehicleKey) || ControlFreak2.CF2Input.GetKeyDown(alternateNextVehicleKey))
			SelectNextVehicle();
		}
